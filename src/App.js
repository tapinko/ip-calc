...
const App = () => {
    ...
    const [classOutput, ClassOutput] = useState("");
    ...
    const updateBtn = () => {
        ...
        ClassOutput(whichClass(ipAddressInput));
    }
        ...
        <div>
            ...
            <article>
                <div id="output_container">
                    ...
                    <div class="output_subcontainer">
                        <span class="output_span_names">Class: </span>
                        <span>{classOutput}</span>
                    </div>
                </div>
